                    ...
                    {videoUrl && !videoError ? (
                      <div className="relative w-full h-full">
                        ...
                        {videoUrl.includes('<iframe') && videoUrl.includes('</iframe>') ? (
                          <div 
                            className="w-full h-full rounded-xl overflow-hidden video-player-container"
                          ...
                          <iframe
                            ...
                            allowFullScreen
                            sandbox="allow-scripts allow-same-origin allow-presentation allow-popups allow-forms allow-top-navigation"
                            onLoad={() => {
                              setIsVideoLoading(false);
                              console.log('Video iframe loaded successfully for URL:', getVideoUrlForPlayer(videoUrl));
                              console.log('Full iframe src attribute:', getVideoUrlForPlayer(videoUrl));
                            }}
                            onError={() => {
                              console.error('Video iframe failed to load for URL:', getVideoUrlForPlayer(videoUrl));
                              console.error('This could be due to: 1) Invalid URL 2) Network issues 3) Platform blocking');
                              setVideoError(true);
                              setIsVideoLoading(false);
                            }}
                            style={{
